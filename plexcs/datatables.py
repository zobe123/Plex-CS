...
from plexcs import logger, helpers, database
...
class DataTables(object):
    ...
    def ssp_query(self,
        ...
        if not table_name:
            logger.error('Plex:CS DataTables :: No table name received.')
            return None
        ...
        if kwargs.get('json_data'):
            ...
            logger.error('Plex:CS DataTables :: Parameters for Datatables must be sent as a serialised json object '
                         'named json_data.')
            return None
