...
from plexcs import logger, datatables, common, database, helpers
...
class DataFactory(object):
    ...
    def delete_session_history_rows(self, row_id=None):
        ...
        if row_id.isdigit():
            logger.info(u"Plex:CS DataFactory :: Deleting row id %s from the session history database." % row_id)
            session_history_del = \
    ...
    def delete_all_user_history(self, user_id=None):
        ...
        if user_id.isdigit():
            logger.info(u"Plex:CS DataFactory :: Deleting all history for user id %s from database." % user_id)
            session_history_media_info_del = \
    ...
    def delete_user(self, user_id=None):
        ...
        if user_id.isdigit():
            ...
            logger.info(u"Plex:CS DataFactory :: Deleting user with id %s from database." % user_id)
    ...
    def undelete_user(self, user_id=None, username=None):
        ...
        if user_id and user_id.isdigit():
            logger.info(u"Plex:CS DataFactory :: Re-adding user with id %s to database." % user_id)
            ...
            logger.info(u"Plex:CS DataFactory :: Re-adding user with username %s to database." % username)
    ...
    def update_rating_key(self, old_key_list='', new_key_list='', media_type=''):
        ...
        if mapping:
            logger.info(u"Plex:CS DataFactory :: Updating rating keys in the database.")
