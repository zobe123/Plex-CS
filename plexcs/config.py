...
_CONFIG_DEFINITIONS = {
    ...
    'PMS_UUID': (str, 'PMS', ''),
    'PMS2_IDENTIFIER': (str, 'PMS2', ''),
    'PMS2_IP': (str, 'PMS2', '127.0.0.1'),
    'PMS2_IS_REMOTE': (int, 'PMS2', 0),
    'PMS2_LOGS_FOLDER': (str, 'PMS2', ''),
    'PMS2_NAME': (unicode, 'PMS2', ''),
    'PMS2_PORT': (int, 'PMS2', 32400),
    'PMS2_TOKEN': (str, 'PMS2', ''),
    'PMS2_SSL': (int, 'General', 0),
    'PMS2_URL': (str, 'PMS2', ''),
    ...
    'OSX_NOTIFY_APP': (str, 'OSX_Notify', '/Applications/Plex:CS'),
    ...
    'TWITTER_PREFIX': (str, 'Twitter', 'Plex:CS'),
...
class Config(object):
    ...
    def write(self):
        ...
        # Write it to file
        plexcs.logger.info("Writing configuration to file")

        try:
            new_config.write()
        except IOError as e:
            plexcs.logger.error("Error writing configuration file: %s", e)
