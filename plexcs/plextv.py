...
from plexcs import logger, helpers, users, http_handler, database
import xmltodict
import json
...
class PlexTV(object):
    ...
    def __init__(self, username=None, password=None):
        ...
        self.ssl_verify = plexcs.CONFIG.VERIFY_SSL_CERT
    ...
    def get_plex_auth(self, output_format='raw'):
        ...
        headers = {'Content-Type': 'application/xml; charset=utf-8',
                   'Content-Length': '0',
                   'X-Plex-Device-Name': 'Plex:CS',
                   'X-Plex-Product': 'Plex:CS',
                   'X-Plex-Version': 'v0.1 dev',
                   'X-Plex-Client-Identifier': plexcs.CONFIG.PMS_UUID,
